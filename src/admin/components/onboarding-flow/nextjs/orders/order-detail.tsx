    ...
    return (
        <>
            <Text size="small" className="mb-6">
                You finished the setup guide 🎉. You now have a complete ecommerce store with a backend, admin, and a
                Next.js storefront. Feel free to play around with each of these components to experience all commerce
                features that Medusa provides.
            </Text>
            <Heading level="h2" className="text-ui-fg-base border-ui-border-base mb-2 border-t border-solid pt-6">
                Continue Building your Ecommerce Store
            </Heading>
            <Text size="small">
                Your ecommerce store provides all basic ecommerce features you need to start selling. You can add more
                functionalities, add plugins for third-party integrations, and customize the storefront’s look and feel
            ...
            <div className="border-ui-border-base mb-6 mt-6 grid auto-rows-fr grid-cols-3 gap-4 border-b border-solid pb-6">
                ...
                >
                    <div className="rounded-rounded bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover flex items-start p-3">
                        ...
                        <div>
                            <Text size="xsmall" weight="plus" className="text-ui-fg-base mb-1">
                ...
                <a href={`https://docs.medusajs.com/modules/overview${queryParams}`} target="_blank" className="flex">
                    <div className="rounded-rounded bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover flex items-start p-3">
                        <div className="mr-4">
                            <div className="bg-ui-bg-base border-ui-border-strong flex items-center justify-center rounded-lg border p-1">
                                <IconBadge>
                        ...
                        <div>
                            ...
                            <Text size="small">
                                Learn about all available commerce features and how to add them in your storefront
                            </Text>
                        </div>
                    </div>
                </a>
                <a href={`https://docs.medusajs.com/recipes${queryParams}`} target="_blank" className="flex">
                    <div className="rounded-rounded bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover flex items-start p-3">
                        <div className="mr-4">
                            <div className="bg-ui-bg-base border-ui-border-strong flex items-center justify-center rounded-lg border p-1">
                                <IconBadge>
                        ...
                        <div>
                            ...
                            <Text size="small">
                                Build a marketplace, subscription-based purchases, or your custom use-cases.
                            </Text>
                        </div>
                    </div>
                </a>
