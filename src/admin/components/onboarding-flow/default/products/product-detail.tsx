...
const ProductDetailDefault = ({ onNext, isComplete, data }: StepContentProps) => {
    ...
    const backendUrl =
        process.env.MEDUSA_BACKEND_URL === "/" || process.env.MEDUSA_ADMIN_BACKEND_URL === "/"
            ? location.origin
            : process.env.MEDUSA_BACKEND_URL || process.env.MEDUSA_ADMIN_BACKEND_URL || "http://localhost:8081";
    ...
    return (
        <div>
            <div className="flex flex-col gap-2">
                ...
                <Text>
                    You can preview your product using Medusa's Store APIs. You can copy any of the following code
                    snippets to try it out.
                </Text>
            </div>
            <div>
                {!isLoading && (
